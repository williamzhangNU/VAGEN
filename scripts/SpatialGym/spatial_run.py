...
def parse_args():
    ...
    p.add_argument("--no_think", action="store_true", help="If set, will disable think in the response")
...
def patch_infer_yaml(infer_cfg: Dict[str, Any], output_dir: Path, override: bool, evaluate_cogmap: bool, server_url: str | None = None, no_think: bool = False) -> Dict[str, Any]:
...
def main():
    ...
    try:
        ...
        for task in tasks:
            ...
            infer_cfg = patch_infer_yaml(infer_cfg, task_output_dir, args.override, args.cogmap, server_url, args.no_think)
