...
tmux send-keys -t "$TRAIN_SESSION" "python3 -m vagen.trainer.main_ppo \\
    ...
    actor_rollout_ref.model.path=/home/ubuntu/VAGEN/vagen/env/crossview/pretrained_models/MindCube-Qwen2.5VL-Plain-CGMap-FFR-OUT \\
    ...
    critic.model.path=/home/ubuntu/VAGEN/vagen/env/crossview/pretrained_models/MindCube-Qwen2.5VL-Plain-CGMap-FFR-OUT \\
