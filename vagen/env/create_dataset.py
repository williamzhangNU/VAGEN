...
def create_dataset_from_yaml(yaml_file_path: str, force_gen=False,seed=42,train_path='./train.parquet',test_path='./test.parquet'):
    ...
    for key, value in yaml_config.items():
        ...
        if hasattr(env_config, 'generate_seeds'):
            ...
            print(f"Using {seeds_for_env_train} train seeds generated by {env_name} config's generate_seeds method")
            print(f"Using {seeds_for_env_test} test seeds generated by {env_name} config's generate_seeds method")
        else:
