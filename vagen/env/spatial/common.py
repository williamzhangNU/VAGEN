...
def load_history_manager(combo_dir: str, eval_override: bool = False) -> HistoryManager:
    ...
    """
    return HistoryManager.load_from_dir(combo_dir, eval_override=eval_override)
