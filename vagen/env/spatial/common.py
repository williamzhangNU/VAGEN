...
def load_history_manager(combo_dir: str, eval_override: bool = False, all_tasks: List = None) -> HistoryManager:
    ...
    """
    return HistoryManager.load_from_dir(combo_dir, eval_override=eval_override, all_tasks=all_tasks)
