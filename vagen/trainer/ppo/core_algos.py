...
@torch.no_grad()
def compute_bi_level_gae_advantage_return_new(
        token_level_rewards: torch.Tensor,
        values: torch.Tensor, 
        eos_mask: torch.Tensor,
        sos_mask: torch.Tensor,
...
def compute_high_level_gae_advantage_return(
    ...
    Args:
        ...
        eos_mask (torch.Tensor): Binary mask indicating reward positions of shape (b, response_len)
    ...
    Note:
        ...
        - eos_mask identifies the end of each turn (where rewards are assigned)
