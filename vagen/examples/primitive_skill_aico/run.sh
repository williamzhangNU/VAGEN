...
python -m vagen.env.create_dataset \
    ...
    --train_path "data/primitive_skill-vision-debug/train.parquet" \
    --test_path "data/primitive_skill-vision-debug/test.parquet" \
    --force_gen
...
python3 -m vagen.trainer.main_ppo \
    ...
    trainer.experiment_name='aico_primitive_skill_vision_service' \
