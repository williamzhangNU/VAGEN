...
python -m vagen.env.sokoban.create_dataset \
    --data_dir data/sokoban-text-5-step \
    --max_action_length 5 \
    --dim_room 6 6 \
    --num_boxes 1 \
    --max_steps 100 \
...
python3 -m vagen.trainer.main_ppo \
    ...
    trainer.experiment_name='debug_single_action_5_turn_ppo_kl_masked_gae' \
    ...
    2>&1 | tee debug_single_action_5_turn_ppo_kl_masked_gae.log
