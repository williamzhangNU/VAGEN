...
launch() {
  ...
  CMD="conda activate vagen; python scripts/SpatialGym/spatial_run.py --tasks $TASKS --model_name $MODEL --seed-range $SEED --render-mode $MODE --inference-only $EXTRA 2>&1 | tee $LOG"
